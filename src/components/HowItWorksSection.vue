<template>
  <section id="how-it-works" class="relative py-24 bg-bone-white overflow-hidden">
    ...
    <div class="relative z-10 container mx-auto px-6 text-center max-w-6xl space-y-20">
      <!-- Header -->
      <div
        id="hiw-header"
        data-animate
        ...
        class="mb-16"
      >
        <h2 class="text-4xl md:text-5xl font-extrabold text-charcoal mb-4 tracking-tight">
          How It Works
        </h2>
        <p class="text-lg md:text-xl text-charcoal/80 max-w-2xl mx-auto leading-relaxed">
    ...
    <p class="text-charcoal/70 text-sm md:text-base leading-relaxed">
      ...
      >
        <router-link to="/register">
          <button
            class="bg-golden-brown text-white py-3 px-10 text-lg font-semibold rounded-md hover:bg-opacity-90 transition-all duration-300 transform hover:scale-105 shadow-lg cursor-pointer"
          >
            Book a Pickup
          </button>
        </router-link>
